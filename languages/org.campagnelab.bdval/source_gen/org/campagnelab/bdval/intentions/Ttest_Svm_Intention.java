...
public class Ttest_Svm_Intention implements IntentionFactory {
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SLinkOperations.setNewChild(SLinkOperations.addNewChild(SLinkOperations.getTarget(node, "featureSelectionInfo", true), "strategy", "org.campagnelab.bdval.structure.FeatureSelectionStrategy"), "step1", "org.campagnelab.bdval.structure.Ttest");
