...
public class DataSet_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_5gxpkq_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_5gxpkq_o0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_5gxpkq_p0(editorContext, node));
    if (renderingCondition_5gxpkq_a61a(node, editorContext)) {
      editorCell.addEditorCell(this.createRefNode_5gxpkq_q0(editorContext, node));
    }
    editorCell.addEditorCell(this.createConstant_5gxpkq_r0(editorContext, node));
    if (renderingCondition_5gxpkq_a81a(node, editorContext)) {
    ...
    if (renderingCondition_5gxpkq_a91a(node, editorContext)) {
      editorCell.addEditorCell(this.createReadOnlyModelAccessor_5gxpkq_t0(editorContext, node));
    }
    ...
    if (renderingCondition_5gxpkq_a12a(node, editorContext)) {
      editorCell.addEditorCell(this.createRefCell_5gxpkq_v0(editorContext, node));
    }
    editorCell.addEditorCell(this.createConstant_5gxpkq_w0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_5gxpkq_o0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
  ...
  private EditorCell createRefNode_5gxpkq_q0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
  ...
  private static boolean renderingCondition_5gxpkq_a61a(SNode node, EditorContext editorContext) {
  ...
  private static boolean renderingCondition_5gxpkq_a81a(SNode node, EditorContext editorContext) {
    return ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(node, "input", true), "sample", true)).isNotEmpty();
  }

  private EditorCell createReadOnlyModelAccessor_5gxpkq_t0(final EditorContext editorContext, final SNode node) {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_5gxpkq_t0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private EditorCell createRefCell_5gxpkq_v0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("input");
    provider.setNoTargetText("<no input>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new DataSet_Editor._Inline_5gxpkq_a12a());
    editorCell = provider.createEditorCell(editorContext);
    if (editorCell.getRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setRole("input");
  ...
  public static class _Inline_5gxpkq_a12a extends InlineCellProvider {
    public _Inline_5gxpkq_a12a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createCollection_5gxpkq_a0v0(editorContext, node);
    }

    private EditorCell createCollection_5gxpkq_a0v0(EditorContext editorContext, SNode node) {
      EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
      editorCell.setCellId("Collection_5gxpkq_a0v0");
      editorCell.addEditorCell(this.createRefNodeList_5gxpkq_a0a12a(editorContext, node));
      return editorCell;
    }

    private EditorCell createRefNodeList_5gxpkq_a0a12a(EditorContext editorContext, SNode node) {
      AbstractCellListHandler handler = new DataSet_Editor._Inline_5gxpkq_a12a.sampleListHandler_5gxpkq_a0a12a(node, "sample", editorContext);
    ...
    private static class sampleListHandler_5gxpkq_a0a12a extends RefNodeListHandler {
      public sampleListHandler_5gxpkq_a0a12a(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_5gxpkq_w0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_5gxpkq_w0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
