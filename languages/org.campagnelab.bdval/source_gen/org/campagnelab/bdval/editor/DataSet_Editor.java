...
public class DataSet_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_5gxpkq_a(EditorContext editorContext, SNode node) {
    ...
    if (renderingCondition_5gxpkq_a71a(node, editorContext)) {
      editorCell.addEditorCell(this.createCollection_5gxpkq_r0(editorContext, node));
    }
  ...
  private EditorCell createCollection_5gxpkq_r0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_5gxpkq_r0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    if (renderingCondition_5gxpkq_a0r0(node, editorContext)) {
      editorCell.addEditorCell(this.createCollection_5gxpkq_a71a(editorContext, node));
    }
    editorCell.addEditorCell(this.createConstant_5gxpkq_b71a(editorContext, node));
    if (renderingCondition_5gxpkq_a2r0(node, editorContext)) {
      editorCell.addEditorCell(this.createReadOnlyModelAccessor_5gxpkq_c71a(editorContext, node));
    }
    editorCell.addEditorCell(this.createConstant_5gxpkq_d71a(editorContext, node));
    editorCell.addEditorCell(this.createRefCell_5gxpkq_e71a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createCollection_5gxpkq_a71a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_5gxpkq_a71a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(this.createJComponent_5gxpkq_a0r0(editorContext, node));
    return editorCell;
  }

  private static boolean renderingCondition_5gxpkq_a0r0(SNode node, EditorContext editorContext) {
    ...
    }).isNotEmpty() && ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(node, "input", true), "sample", true)).isNotEmpty();
  }

  private EditorCell createJComponent_5gxpkq_a0r0(EditorContext editorContext, SNode node) {
    EditorCell editorCell = EditorCell_Component.createComponentCell(editorContext, node, DataSet_Editor._QueryFunction_JComponent_5gxpkq_a0a71a(node, editorContext), "_5gxpkq_a0r0");
    editorCell.setCellId("JComponent_5gxpkq_a0r0");
    return editorCell;
  }

  private static JComponent _QueryFunction_JComponent_5gxpkq_a0a71a(final SNode node, final EditorContext editorContext) {
  ...
  private EditorCell createConstant_5gxpkq_b71a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Number of Known Conditions:");
    editorCell.setCellId("Constant_5gxpkq_b71a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
  ...
  private EditorCell createReadOnlyModelAccessor_5gxpkq_c71a(final EditorContext editorContext, final SNode node) {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_5gxpkq_c71a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(MPSColors.darkGray));
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private static boolean renderingCondition_5gxpkq_a2r0(SNode node, EditorContext editorContext) {
    return ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(node, "input", true), "sample", true)).isNotEmpty();
  }

  private EditorCell createConstant_5gxpkq_d71a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Sample Label:");
    editorCell.setCellId("Constant_5gxpkq_d71a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_5gxpkq_e71a(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("input");
    provider.setNoTargetText("<no input>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new DataSet_Editor._Inline_5gxpkq_a4r0());
    editorCell = provider.createEditorCell(editorContext);
    if (editorCell.getRole() == null) {
  ...
  public static class _Inline_5gxpkq_a4r0 extends InlineCellProvider {
    public _Inline_5gxpkq_a4r0() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createCollection_5gxpkq_a0e71a(editorContext, node);
    }

    private EditorCell createCollection_5gxpkq_a0e71a(EditorContext editorContext, SNode node) {
      EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
      editorCell.setCellId("Collection_5gxpkq_a0e71a");
      editorCell.addEditorCell(this.createRefNodeList_5gxpkq_a0a4r0(editorContext, node));
      return editorCell;
    }

    private EditorCell createRefNodeList_5gxpkq_a0a4r0(EditorContext editorContext, SNode node) {
      AbstractCellListHandler handler = new DataSet_Editor._Inline_5gxpkq_a4r0.sampleListHandler_5gxpkq_a0a4r0(node, "sample", editorContext);
    ...
    private static class sampleListHandler_5gxpkq_a0a4r0 extends RefNodeListHandler {
      public sampleListHandler_5gxpkq_a0a4r0(SNode ownerNode, String childRole, EditorContext context) {
