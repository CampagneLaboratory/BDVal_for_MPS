...
public class FoldchangeProperties_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_imokuc_a(editorContext, node);
  }

  private EditorCell createCollection_imokuc_a(EditorContext editorContext, SNode node) {
