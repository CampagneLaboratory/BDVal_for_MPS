...
public class Endpoint_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_g320ff_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_g320ff_a0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_g320ff_b0(editorContext, node));
  ...
  private EditorCell createConstant_g320ff_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createProperty_g320ff_b0(EditorContext editorContext, SNode node) {
