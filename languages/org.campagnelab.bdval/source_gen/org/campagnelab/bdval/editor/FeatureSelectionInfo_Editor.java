...
public class FeatureSelectionInfo_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_f0jmv8_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_f0jmv8_b0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createRefNodeList_f0jmv8_h0(editorContext, node));
  ...
  private EditorCell createProperty_f0jmv8_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNodeList_f0jmv8_d0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new FeatureSelectionInfo_Editor.numberOfFeaturesListHandler_f0jmv8_d0(node, "numberOfFeatures", editorContext);
  ...
  private static class numberOfFeaturesListHandler_f0jmv8_d0 extends RefNodeListHandler {
    public numberOfFeaturesListHandler_f0jmv8_d0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createRefNodeList_f0jmv8_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new FeatureSelectionInfo_Editor.featureSelectionFoldListHandler_f0jmv8_f0(node, "featureSelectionFold", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class featureSelectionFoldListHandler_f0jmv8_f0 extends RefNodeListHandler {
    public featureSelectionFoldListHandler_f0jmv8_f0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
  ...
  private EditorCell createRefNodeList_f0jmv8_h0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new FeatureSelectionInfo_Editor.featureSelectionListHandler_f0jmv8_h0(node, "featureSelection", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class featureSelectionListHandler_f0jmv8_h0 extends RefNodeListHandler {
    public featureSelectionListHandler_f0jmv8_h0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
