...
public class Approach_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6do0s2_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_6do0s2_l0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createConstant_6do0s2_o0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_6do0s2_p0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_6do0s2_q0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_6do0s2_r0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_6do0s2_b0(EditorContext editorContext, SNode node) {
    ...
    provider.setRole("specificGeneLists");
    provider.setNoTargetText("<no specificGeneLists>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(editorContext);
    editorCell.setCellId("property_specificGeneLists");
  ...
  private EditorCell createProperty_6do0s2_l0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
  ...
  private EditorCell createRefNodeList_6do0s2_n0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Approach_Editor.numFeaturesListHandler_6do0s2_n0(node, "numFeatures", editorContext);
  ...
  private static class numFeaturesListHandler_6do0s2_n0 extends RefNodeListHandler {
    public numFeaturesListHandler_6do0s2_n0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_6do0s2_o0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Feature Selection:");
    editorCell.setCellId("Constant_6do0s2_o0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createRefNodeList_6do0s2_p0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Approach_Editor.featureSelectionListHandler_6do0s2_p0(node, "featureSelection", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class featureSelectionListHandler_6do0s2_p0 extends RefNodeListHandler {
    public featureSelectionListHandler_6do0s2_p0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
  ...
  private EditorCell createRefNodeList_6do0s2_r0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Approach_Editor.classificationListHandler_6do0s2_r0(node, "classification", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class classificationListHandler_6do0s2_r0 extends RefNodeListHandler {
    public classificationListHandler_6do0s2_r0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
