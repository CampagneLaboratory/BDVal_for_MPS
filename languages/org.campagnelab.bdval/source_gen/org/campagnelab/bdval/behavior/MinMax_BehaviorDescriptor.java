...
public class MinMax_BehaviorDescriptor extends BaseConcept_BehaviorDescriptor implements FeatureSelection_BehaviorDescriptor {
  ...
  public String virtual_getEvaluateCommand_1277192072314969653(SNode thisNode, boolean first, boolean twoFS, boolean genelist, String splitType) {
    return MinMax_Behavior.virtual_getEvaluateCommand_1277192072314969653(thisNode, first, twoFS, genelist, splitType);
  }
  ...
  public String virtual_getFinalModelCommand_7218745629926480436(SNode thisNode, boolean first, boolean twoFS, boolean genelist) {
    return MinMax_Behavior.virtual_getFinalModelCommand_7218745629926480436(thisNode, first, twoFS, genelist);
  }
