...
public class MinMax_Behavior {
  ...
  public static String virtual_getEvaluateCommand_1277192072314969653(SNode thisNode, boolean first, boolean twoFS, boolean genelist, String splitType) {
    String observations = String.valueOf(SPropertyOperations.getInteger(SLinkOperations.getTarget(SLinkOperations.getTarget(SNodeOperations.getAncestor(thisNode, "org.campagnelab.bdval.structure.FeatureSelectionInfo", false, false), "parameters", true), "minMax", true), "observations"));
