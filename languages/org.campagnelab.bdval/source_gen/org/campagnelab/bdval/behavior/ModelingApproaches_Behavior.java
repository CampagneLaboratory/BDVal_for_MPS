...
public class ModelingApproaches_Behavior {
      ...
      public void visit(final SNode fsFold) {
        ...
        ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(thisNode, "classificationInfo", true), "classification", true)).visitAll(new IVisitor<SNode>() {
          public void visit(final SNode classification) {
            ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(thisNode, "featureSelectionInfo", true), "strategy", true)).visitAll(new IVisitor<SNode>() {
              public void visit(SNode featureCombo) {
                twoFS.value = (SLinkOperations.getTarget(featureCombo, "step2", true) != null);
                genelist.value = SNodeOperations.isInstanceOf(SLinkOperations.getTarget(featureCombo, "step1", true), "org.campagnelab.bdval.structure.Genelist") || SNodeOperations.isInstanceOf(SLinkOperations.getTarget(featureCombo, "step2", true), "org.campagnelab.bdval.structure.Genelist");
                wholeChip.value = SNodeOperations.isInstanceOf(SLinkOperations.getTarget(featureCombo, "step1", true), "org.campagnelab.bdval.structure.WholeChip");
                geneticAlgorithm.value = SNodeOperations.isInstanceOf(SLinkOperations.getTarget(featureCombo, "step1", true), "org.campagnelab.bdval.structure.GeneticAlgorithm") || SNodeOperations.isInstanceOf(SLinkOperations.getTarget(featureCombo, "step2", true), "org.campagnelab.bdval.structure.GeneticAlgorithm");

                SNode fs1 = SLinkOperations.getTarget(featureCombo, "step1", true);
                ...
                otherOptions.value = SPropertyOperations.getString(SLinkOperations.getTarget(featureCombo, "step1", true), "otherOptions");

                if (twoFS.value) {
                  SNode fs2 = SLinkOperations.getTarget(featureCombo, "step2", true);
                ...
                if ((SLinkOperations.getTarget(featureCombo, "option", true) != null)) {
                  label.value = label.value + "-" + SPropertyOperations.getString(SLinkOperations.getTarget(featureCombo, "option", true), "name");
                  defs.value = defs.value + SPropertyOperations.getString(SLinkOperations.getTarget(featureCombo, "option", true), "def");
                  addoptions.value = addoptions.value + SPropertyOperations.getString(SLinkOperations.getTarget(featureCombo, "option", true), "addoptions");
                  otherOptions.value = otherOptions.value + SPropertyOperations.getString(SLinkOperations.getTarget(featureCombo, "option", true), "otherOptions");
                }
                ...
                if (!(wholeChip.value && fsFoldNum.value > 1)) {
                  ...
                  if (genelist.value) {
                    ListSequence.fromList(SLinkOperations.getTargets(SNodeOperations.cast(SNodeOperations.getParent(thisNode), "org.campagnelab.bdval.structure.Project"), "dataset", true)).where(new IWhereFilter<SNode>() {
                      ...
                      public void visit(final SNode genelistNode) {
                        ...
                        try {
                          ...
                          writer.print(ModelingApproaches_Behavior.call_getEvaluateModelLine_1870354875254016704(thisNode, (genelist.value && !(twoFS.value)), wholeChip.value, geneticAlgorithm.value, SPropertyOperations.getString(classification, "name")));
                        ...
                        try {
                          ...
                          writer.print(ModelingApproaches_Behavior.call_getFinalModelLine_7218745629927269133(thisNode, (genelist.value && !(twoFS.value)), wholeChip.value, geneticAlgorithm.value));
                          writer.close();
                          file.close();
                        } catch (Exception e) {
                          if (LOG.isEnabledFor(Level.ERROR)) {
                    ...
                    if (SPropertyOperations.getString(classification, "name").matches("SVMTuneC")) {
                      ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(SLinkOperations.getTarget(SLinkOperations.getTarget(thisNode, "classificationInfo", true), "classificationProperties", true), "svmTuneCProperties", true), "cValue", true)).visitAll(new IVisitor<SNode>() {
                        public void visit(SNode cValue) {
                          ModelingApproaches_Behavior.call_generateModel_8241402136296602911(thisNode, label.value, SPropertyOperations.getString(cValue, "value"), SPropertyOperations.getBoolean(fsFold, "value"), SPropertyOperations.getString(classification, "classname"), SPropertyOperations.getString(classification, "parameters"), otherOptions.value + SPropertyOperations.getString(classification, "otherOption"));
                        }
                      });
                    } else {
                      ModelingApproaches_Behavior.call_generateModel_8241402136296602911(thisNode, label.value, "", SPropertyOperations.getBoolean(fsFold, "value"), SPropertyOperations.getString(classification, "classname"), SPropertyOperations.getString(classification, "parameters"), otherOptions.value + SPropertyOperations.getString(classification, "otherOption"));
                    }
                    // Writes predict sequence file 
                    try {
  ...
  protected static Logger LOG = LogManager.getLogger(ModelingApproaches_Behavior.class);
}
