...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 2:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Condition").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept").create();
      case 3:
      ...
      case 8:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Input").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("fileName", "numberOfSamples", "numberOfKnownConditions").children(new String[]{"sample", "displayRow"}, new boolean[]{true, true}).alias("input", "File containing input (table of ID's and genes)").create();
      case 9:
      ...
      case 15:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.TestsToRun").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("useFeatureSelectionFoldTrue", "useFeatureSelectionFoldFalse", "baseline", "baselineTuneC", "naiveBayes", "logitBoost", "logistic", "randomForest", "kStar", "wholeChip", "foldchangeGeneticAlgorithm", "foldchangeSvmGlobal", "foldchangeSvmIterative", "fullGeneticAlgorithm", "genelistGeneticAlgorithm", "genelistSvmGlobal", "genelistSvmGlobalTuneC", "minMaxSvmGlobal", "pathwaysBuildPathwayComponents", "pathwaysTtestSvmGlobal", "pathwaysTuneC", "pathwaysBaseline", "svmIterative", "ttestGeneticAlgorithm", "ttestSvmGlobal", "ttestSvmIterative").children(new String[]{"condition"}, new boolean[]{true}).create();
      case 16:
