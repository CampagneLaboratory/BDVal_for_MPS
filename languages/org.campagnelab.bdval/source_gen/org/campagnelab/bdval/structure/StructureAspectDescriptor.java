...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 3:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.CIDs").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").children(new String[]{"file", "mismatches"}, new boolean[]{false, true}).alias("cids", "File containing phenotypes and Ids in columns").create();
      case 4:
      ...
      case 44:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.OtherFiles").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").children(new String[]{"pathwaysFile", "geneToProbesFile", "survivalFile"}, new boolean[]{false, false, false}).create();
      case 45:
      ...
      case 51:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Platform").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").children(new String[]{"file"}, new boolean[]{false}).alias("platform", "File containing platform").create();
      case 52:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Project").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept").properties("trimmedName", "projectFolder", "proceed", "test1", "test2", "test3").children(new String[]{"properties", "approach", "endpoint", "dataset"}, new boolean[]{false, false, true, true}).alias("project", "An entire project which can contain multiple datasets ").create();
      case 53:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Properties").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("threads", "memory", "tagDescription").children(new String[]{"outputDirectory", "bdvalDirectory", "antDirectory", "computerType"}, new boolean[]{false, false, false, false}).create();
      case 54:
