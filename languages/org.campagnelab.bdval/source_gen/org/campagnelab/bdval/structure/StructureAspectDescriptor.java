...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      case 0:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.CIDs").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("fileName", "numberOfSamples").children(new String[]{"mismatches"}, new boolean[]{true}).alias("cids", "File containing phenotypes and Ids in columns").create();
      case 1:
      ...
      case 7:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Evaluate").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("property").create();
      case 8:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.GeneticAlgorithm").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("property").create();
      case 9:
      ...
      case 10:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Pathway").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("property").create();
      case 11:
      ...
      case 13:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Properties").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("outputLocation", "bdvalLocation", "computerType", "threadsServer", "memoryServer", "threadsDesktop", "memoryDesktop", "doSpecificGeneListsOnly", "enableFlooring", "gaWrapperPopulationSize", "gaWrapperNumberOfIterations", "performanceMeasureMaximized", "internalRepeats", "internalFolds", "externalRepeats", "externalFolds", "maxIntermediateFeatures", "useProbability", "foldChangePhi", "ttestAlpha", "pathwayAggregationMethod").children(new String[]{"numFeatures", "evaluate", "pathway", "genetic", "tuneC"}, new boolean[]{true, true, true, true, true}).create();
      case 14:
      ...
      case 17:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.TuneC").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("property").create();
      case 18:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Values").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("value").create();
      default:
