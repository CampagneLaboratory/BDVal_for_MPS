...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 1:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Approach").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("enableFlooring", "evaluateStatistics", "externalRepeats", "externalFolds").children(new String[]{"featureSelectionInfo", "classification"}, new boolean[]{false, true}).create();
      case 2:
      ...
      case 16:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.FeatureSelectionCombo").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").children(new String[]{"featureSelection"}, new boolean[]{true}).create();
      case 17:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.FeatureSelectionFold").interface_().parents("jetbrains.mps.lang.core.structure.INamedConcept").create();
      case 18:
      ...
      case 40:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.NewFeatureSelection").interface_().parents("jetbrains.mps.lang.core.structure.INamedConcept").create();
      case 41:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.NewFeatureSelectionInfo").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").properties("maxIntermediateFeatures").children(new String[]{"numberOfFeatures", "featureSelectionFold", "featureSelectionCombo"}, new boolean[]{true, true, true}).create();
      case 42:
      ...
      case 66:
        return new ConceptDescriptorBuilder("org.campagnelab.bdval.structure.Ttest").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "org.campagnelab.bdval.structure.NewFeatureSelection").create();
      case 67:
